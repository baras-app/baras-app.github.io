...
Total healing output by each player.

### Effective Healing

Healing that actually restored health. Excludes overhealing, showing only healing that filled missing health bars.

### Shielding Given

Shield and barrier absorption provided to allies.
...
Threat generated by each player.
